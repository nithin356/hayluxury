...
<script>
    ...
    function updateLightboxImage() {
        ...
        currentImages.forEach((src, idx) => {
            ...
            thumb.onclick = (e) => { e.stopPropagation(); currentIndex = idx; updateLightboxImage(); };
...
<div id="lightbox" onclick="this.style.display='none'; document.body.style.overflow='auto';">
    <span class="close" onclick="document.getElementById('lightbox').style.display='none'; document.body.style.overflow='auto';">&times;</span>
...
<div id="qa-banner" class="qa-banner">
    <div class="qa-text">
        QUALITY ASSURANCE: All products <span class="qa-highlight">18 karat gold and diamond</span> · In Dubai: <span class="qa-highlight">COD available</span> - Check, examine, and purchase with confidence
    </div>
    <button class="qa-close" onclick="document.getElementById('qa-banner').style.display='none'; document.body.style.paddingTop='0';">&times;</button>
</div>

<header>
    <?php if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true): ?>
        <a href="/hayluxury/admin/logout.php" style="position: absolute; top: 10px; right: 20px; font-size: 10px; text-transform: uppercase; color: red;">Logout</a>
    <?php endif; ?>
    ...
    <nav>
        <ul>
            <li><a href="/hayluxury/index.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'index.php' && !isset($_GET['cat']) ? 'active' : ''; ?>">All</a></li>
            <?php
